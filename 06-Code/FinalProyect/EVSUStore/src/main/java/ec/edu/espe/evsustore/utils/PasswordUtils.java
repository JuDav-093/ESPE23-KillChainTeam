...
public class PasswordUtils {
    ...
    public void migratePasswordsToBCrypt(MongoCollection<Document> collection) {
        BasicDBObject query = new BasicDBObject();
    ...
    public boolean createUser(String name, String lastName, String username, String password, MongoCollection<Document> collection) {
        BasicDBObject query = new BasicDBObject();
        query.put("username", username);
    ...
    public boolean changePassword(String confirmPassword, MongoCollection<Document> collection) {
    ...
    public String getPasswordByUsername(String username, MongoCollection<Document> collection) {
        BasicDBObject query = new BasicDBObject();
        query.put("username", username);
    ...
    public boolean updatePassword(String username, String newPassword, String temporaryPassword, MongoCollection<Document> collection) {
        BasicDBObject query = new BasicDBObject();
        query.put("username", username);
