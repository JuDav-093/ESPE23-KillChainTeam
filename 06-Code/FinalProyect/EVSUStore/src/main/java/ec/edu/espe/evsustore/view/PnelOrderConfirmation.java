...
public class PnelOrderConfirmation extends javax.swing.JPanel {
    ...
    private void addProducts(){
        ...
        int selectedQuantity = (int) spinnerQuantity.getValue();
        int availableQuantity = (int) catalogProduct.get("quantity");
        if (selectedQuantity <= availableQuantity) {
            catalogProduct.put("quantity", availableQuantity - selectedQuantity);
        }
    }
